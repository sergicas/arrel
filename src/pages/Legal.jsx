  ...
  const getContent = () => {
        ...
        <div className="max-w-xl mx-auto">
          <div className="bg-purple-50 p-6 rounded-2xl mb-8 border border-purple-100">
            <h3 className="text-lg font-bold text-gray-900 mb-2 flex items-center gap-2">
              👋 Hola! Darrere d'Arrel hi ha persones reals.
            </h3>
            <p className="text-gray-700 text-sm mb-2">
              Res de respostes automàtiques. Som un equip petit apassionat per la teva salut i
              llegim cada missatge. Si tens un dubte o suggeriment, som tot orelles.
            </p>
            <p className="text-gray-500 text-xs italic">
              ⏱️ Et respondrem nosaltres mateixos en <strong>24-48 hores</strong>.
            </p>
          </div>
    ...
    if (section === 'privacitat') {
      return (
        <div className="space-y-8 text-gray-600 leading-relaxed">
          {/* HUMAN SUMMARY BOX - 30s Read */}
          <div className="bg-purple-50 p-8 rounded-2xl border border-purple-100 shadow-sm">
            <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <Shield className="text-purple-600" />
              Resum Humà (Lectura en 30s)
            </h3>
            <p className="mb-4 text-gray-700">
              Volem ser transparents: a Arrel les teves dades són teves. Aquí tens el que realment
              t'importa, sense lletra petita:
            </p>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-bold text-gray-900 mb-2 text-sm uppercase tracking-wide">
                  ✅ Què recollim (Només al teu dispositiu)
                </h4>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-green-500 mt-0.5" />
                    Les teves respostes al test.
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-green-500 mt-0.5" />
                    El teu progrés diari d'hàbits.
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    No tenim servidors centrals (Núvol).
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 font-bold">×</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-500 font-bold">×</span>
                    No et rastregem fora d'aquesta web.
                  </li>
                </ul>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-purple-100 text-sm text-gray-500 italic">
              En resum: Tot el que fas a Arrel es queda al teu ordinador o mòbil. Ets l'únic
              propietari de la teva salut.
            </div>
          </div>
          ...
          <p>
            Arrel està dissenyat amb un principi fonamental:{' '}
            <strong>les teves dades biològiques són teves</strong>.
          </p>
          <p>
            A diferència de la majoria d'aplicacions de salut, Arrel <strong>NO</strong> té
            servidors centrals on s'emmagatzemin les teves respostes, puntuacions o diaris. Tota la
            informació es guarda exclusivament a la memòria <code>LocalStorage</code> del teu
            navegador.
          </p>
          ...
          <p>
            Aquestes dades mai surten del teu dispositiu sense el teu consentiment explícit (per
            exemple, si tu decideixes compartir una captura de pantalla).
          </p>

          <h3 className="text-xl font-bold text-gray-900">3. Eliminació de Dades</h3>
          <p>
            Pots eliminar totes les teves dades en qualsevol moment simplement esborrant la memòria
            cau i les dades del lloc web des de la configuració del teu navegador.
          </p>
        </div>
      );
    }
    ...
    if (section === 'termes') {
      return (
        <div className="space-y-6 text-gray-600 leading-relaxed">
          <p>
            La transparència i la teva seguretat són el primer. Aquí tens els termes sense
          ...
          <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 text-yellow-800">
            <p className="font-bold">
              Arrel NO és un dispositiu mèdic ni substitueix el consell, diagnòstic o tractament
              mèdic professional.
            </p>
          </div>
          <p>
            El contingut d'aquesta aplicació està basat en evidència científica sobre hàbits de vida
            saludable i longevitat, però s'ofereix únicament amb finalitats informatives i
            educatives.
          </p>
          <p>
            Sempre consulta amb el teu metge o professional de la salut abans de començar qualsevol
            nou protocol d'exercici, nutrició o suplementació, especialment si tens condicions
            mèdiques preexistents.
          </p>

          <h3 className="text-xl font-bold text-gray-900">Ús de la Versió Beta</h3>
          <p>
            Actualment Arrel es troba en fase "Beta Privada". Això significa que el programari pot
            contenir errors i estem en procés constant de millora. En utilitzar l'aplicació,
            acceptes que el servei es proporciona "tal qual" sense garanties de cap mena.
          </p>
        </div>
      );
    }
    ...
    if (section === 'cookies') {
      return (
        <div className="space-y-6 text-gray-600 leading-relaxed">
          <p>
            La teva privacitat és intocable. Per això utilitzem una tecnologia anomenada{' '}
            <strong>Local Storage</strong> en lloc de les tradicionals cookies de seguiment.
          </p>
          <h3 className="text-xl font-bold text-gray-900">Diferència clau</h3>
          <p>
            Les cookies sovint s'utilitzen per rastrejar-te a través d'internet. El Local Storage és
            com una petita base de dades privada dins del teu navegador on guardem el teu progrés
            perquè no el perdis en tancar la pestanya.
          </p>
          <p>
            No utilitzem cookies de tercers per a publicitat ni analítica invasiva. L'experiència és
            totalment privada.
          </p>
        </div>
      );
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="prose prose-purple max-w-none">{getContent()}</div>
      </main>
    </div>
  );
}
