...
const Emotional = () => {
    ...
    // ---- STATE: Mood Check-in ----
    const [mood, setMood] = useState(null); // 'great', 'good', 'neutral', 'bad', 'awful'
        ...
        <div className="min-h-screen bg-gray-50 pb-20 p-6">
            ...
            <div className="max-w-md mx-auto space-y-8">
                ...
                <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-3xl p-8 shadow-xl">
                    ...
                    <h3 className="text-lg font-bold text-gray-800 mb-6 text-center">Com et sents ara mateix?</h3>
                ...
                <div className="bg-white/70 backdrop-blur-xl border border-white/50 rounded-3xl p-6 shadow-xl space-y-4">
                    ...
                    <p className="text-sm text-gray-500 mb-4">Transforma l'estrès en creixement. Identifica un repte i canvia la perspectiva.</p>

                    <div className="space-y-4">
                        <div>
                            <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-1 block">El Repte (Estressor)</label>
                            <textarea
                                value={stressor}
