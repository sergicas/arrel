...
const ComFunciona = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-6 md:p-12">
      <SEO
        title="Com Funciona"
        description="Entén la metodologia Arrel: un enfocament integral per optimitzar la teva salut a través de diagnòstic i hàbits personalitzats."
      />
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16 mt-8 animate-enter">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Optimitza la teva salut i alenteix l'envelliment en 4 passos clau.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-purple-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Respon 17 preguntes sobre els teus hàbits i estil de vida.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-blue-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Descobreix la teva puntuació en les 5 àrees clau de la longevitat.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-orange-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Rep 3 accions personalitzades basades en ciència.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-green-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <p className="text-gray-600 text-sm">
                Repeteix el test setmanalment i visualitza el teu progrés.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          ...
          <div className="order-1 md:order-2">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">1. Un Diagnòstic Profund</h2>
            <p className="text-lg text-gray-600 mb-6">
              Més que un test de salut, analitzem marcadors d'envelliment com:
            </p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-6">2. El Teu Mapa Biològic</h2>
            <p className="text-lg text-gray-600 mb-6">
              Visualitza l'impacte dels teus hàbits en temps real.
            </p>
            ...
            <div className="flex bg-gray-100 p-1 rounded-xl w-fit mb-8">
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${chartMode === 'before'
              ...
              <button
                ...
                className={`px-6 py-2 rounded-lg text-sm font-bold transition-all ${chartMode === 'after'
            ...
            <p className="text-sm text-gray-500 bg-purple-50 p-4 rounded-lg italic border-l-4 border-purple-400">
              "L'envelliment és un error en el codi de la informació, i tenim les eines per
              corregir-lo." - Dr. David Sinclair
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div
              className={`absolute -bottom-4 left-1/2 -translate-x-1/2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest shadow-lg transition-all duration-500 ${chartMode === 'after' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                }`}
            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-green-50/50 p-6 rounded-2xl border border-green-100">
              ...
              <p className="text-sm text-gray-600 mb-4">
                El teu sistema biològic funciona amb eficiència. L'objectiu és manteniment.
              </p>
            ...
            <div className="bg-orange-50/50 p-6 rounded-2xl border border-orange-100">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Tens bases sòlides però hi ha fricció. Pots pujar ràpidament.
              </p>
              <ul className="text-xs text-gray-500 space-y-2">
            ...
            <div className="bg-red-50/50 p-6 rounded-2xl border border-red-100">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Desgast accelerat. Cal intervenció prioritària.
              </p>
              <ul className="text-xs text-gray-500 space-y-2">
        ...
        <div className="text-center bg-white/60 backdrop-blur-md rounded-3xl p-10 border border-white shadow-xl max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Estàs a punt per començar?</h2>
