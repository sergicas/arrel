export const diagnosisQuestions = [
  ...
  },
  {
    ...
    context:
      "La dependència d'estimulants suggereix una regulació deficient del cortisol o sucre en sang.",
    options: [
  ...
  // BLOC NOU: SON 🌙
  {
    ...
    context:
      'El son és el procés reparador més important. La quantitat (i qualitat) correlaciona directament amb la longevitat.',
    options: [
  ...
  },
  {
    ...
    context:
      'Despertar-se cansat (inèrcia del son) pot indicar apnees, mala qualitat del son o desajust dels cicles.',
    options: [
  ...
  },
  {
    ...
    context:
      'Els despertars freqüents (fragmentació) impedeixen arribar a fases profundes de reparació cel·lular.',
    options: [
  ...
  // BLOC NOU: NUTRICIÓ 🥗
  {
    ...
    context:
      "Els processats augmenten la inflamació sistèmica, un dels principals acceleradors de l'envelliment.",
    options: [
  ...
  // BLOC B: ATENCIÓ (Ment que s’esgota)
  {
    ...
    context:
      'La capacitat de focus reflecteix la salut del còrtex prefrontal i els nivells de dopamina.',
    options: [
  ...
  // BLOC C: TEMPS VISCUT (Envelliment subjectiu)
  {
    ...
    context:
      "La percepció del temps s'accelera amb l'edat si no introduïm novetat (neuroplasticitat).",
    options: [
  ...
  },
  {
    ...
    context: "La percepció de l'horitzó temporal és un marcador potent d'envelliment psicològic.",
    options: [
