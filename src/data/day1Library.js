export const day1Library = {
    physical: {
        ...
        friction: {
            ...
            description: "Aguanta la posició d'esquat contra la paret fins a la fallada (o màxim 2 min). Sense música.",
    ...
    mental: { // Cognitive
        ...
        friction: {
            ...
            description: "Llegeix un text dens 10 minuts sense apartar la vista. Si apartes la vista, torna a començar.",
    ...
    emotional: { // Stress
        ...
        friction: {
            ...
            description: "Seu en una cadira. Fes res durant 7 minuts. Sense mòbil, sense música, sense dormir.",
    ...
    intellectual: { // Identity
        ...
        micro: {
            ...
            description: "Llegeix una opinió amb la qual discrepes profundament. No la jutgis. Llegeix-la.",
