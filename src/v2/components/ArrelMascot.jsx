...
export default function ArrelMascot({ mood = 'welcome', className = '' }) {
  ...
  return (
    ...
    >
      <ellipse cx="80" cy="134" rx="44" ry="11" fill="#ffd9b3" opacity="0.72" />

      {isWelcome ? (
        <g className="v2-mascot-sparkles" fill="none" stroke="#f26f4f" strokeLinecap="round" strokeWidth="3">
          <path d="M24 38v12M18 44h12" />
          <path d="M130 28v10M125 33h10" />
          <circle cx="140" cy="60" r="3" fill="#ffe7c2" stroke="none" />
        </g>
      ) : null}

      {isAction ? (
        <g className="v2-mascot-prop">
          <rect x="108" y="33" width="32" height="32" rx="12" fill="#fffaf2" />
          <rect x="108" y="33" width="32" height="32" rx="12" fill="none" stroke="#ffc46b" strokeWidth="3" />
          <path d="M117 50.2l5.1 5.3 9-11.1" fill="none" stroke="#c9583b" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
        </g>
      ) : null}

      {isRest ? (
        <g className="v2-mascot-prop">
          <path d="M118 31.5c-9.5 3.8-14 14.8-9.5 24.1 3.8 7.8 12.1 11.8 20.2 10.3-3 4.4-8 7.4-13.8 7.4-9.3 0-16.9-7.5-16.9-16.8 0-10.5 9.6-18.4 20-25Z" fill="#ffd166" />
          <circle cx="130" cy="41" r="2.8" fill="#f26f4f" opacity="0.75" />
        </g>
      ) : null}

      {isCelebrate ? (
        <g className="v2-mascot-confetti" strokeLinecap="round" strokeWidth="4">
          <path d="M26 31l8 8" stroke="#f26f4f" />
          <path d="M136 31l-8 8" stroke="#b879ff" />
          <path d="M43 22l2 11" stroke="#ffd166" />
          <path d="M117 21l-3 11" stroke="#f26f4f" />
          <circle cx="23" cy="66" r="3" fill="#ffd166" />
          <circle cx="139" cy="70" r="3" fill="#f26f4f" />
        </g>
      ) : null}
      ...
      <g className="v2-mascot-body">
        ...
        <path
          ...
          strokeWidth="5.8"
        />
        <ellipse cx="80" cy="81.6" rx="33" ry="35" fill="#fffaf2" />

        {isRest ? (
          <g fill="none" stroke="#3a2530" strokeLinecap="round" strokeWidth="4.8">
          ...
          <>
            <circle cx="67.8" cy="77.7" r="4.7" fill="#3a2530" />
            <circle cx="92.2" cy="77.7" r="4.7" fill="#3a2530" />
            <path
      ...
      <g className="v2-mascot-arms" fill="none" stroke="#9b4d2d" strokeLinecap="round" strokeLinejoin="round" strokeWidth="6">
        {isWelcome ? (
          <>
      ...
      <g className="v2-mascot-roots" fill="none" stroke="#9b4d2d" strokeLinecap="round" strokeWidth="5.2">
